...
CREATE
    ...
    BEGIN
          ...
          UPDATE SEATS SET CONCURRENT_USER_STATE=1 WHERE SEAT_NO=SEAT_NUMB;
...
CALL PR_TAKEORDER('SOUTH INDIAN MEALS,IDLY,vada,pongal,tea,coffee','3,1,2,3,4,5,',2,@MESSAGE,@ERR);
